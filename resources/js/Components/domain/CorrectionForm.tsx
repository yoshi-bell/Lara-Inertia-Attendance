...
interface CorrectionFormProps {
    ...
    setData?: {
        ...
        <K extends keyof CorrectionFormType>(
            key: K,
            value: CorrectionFormType[K]
        ): void;
                        ...
                        {!isEditable ? (
                            <>
                                <span className="w-28 text-center">
                                    {pendingCorrection?.requested_start_time_hi ||
                                        attendance.start_time_hi}
                                </span>
                                <span className="mx-4 font-normal text-gray-400">
                                    〜
                                </span>
                                <span className="w-28 text-center">
                                    {pendingCorrection?.requested_end_time_hi ||
                                        attendance.end_time_hi}
                                </span>
                            </>
                        ) : (
                            <>
                                <div className="flex flex-col">
                                    ...
                                    {errors?.requested_start_time && (
                                        <p className="mt-1 text-xs font-bold text-[#FF0000]">
                                            {errors.requested_start_time}
                                        </p>
                                    )}
                                </div>
